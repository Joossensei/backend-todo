...
Revision ID: dbd22a785046
Revises: c924bffa2328
Create Date: 2025-08-21 10:24:39.519839
...
def downgrade() -> None:
    ...
    sa.UniqueConstraint('key', name='uq_users_key', postgresql_include=[], postgresql_nulls_not_distinct=False),
    ...
    sa.ForeignKeyConstraint(['user_key'], ['users.key'], name='fk_priorities_user_key_users'),
    sa.PrimaryKeyConstraint('id', name='pk_priorities'),
    sa.UniqueConstraint('key', name='uq_priorities_key', postgresql_include=[], postgresql_nulls_not_distinct=False),
    ...
    sa.UniqueConstraint('key', name=op.f('uq_todos_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
