...
down_revision: Union[str, Sequence[str], None] = 'dbd22a785046'
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['user_key'], ['users.key'], name=op.f('fk_priorities_user_key_users')),
    ...
    op.create_index('ix_priority_user_key_key', 'priorities', ['user_key', 'key'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['priority'], ['priorities.key'], name=op.f('fk_todos_priority_priorities')),
    sa.ForeignKeyConstraint(['status'], ['statuses.key'], name=op.f('fk_todos_status_statuses')),
    sa.ForeignKeyConstraint(['user_key'], ['users.key'], name=op.f('fk_todos_user_key_users')),
    ...
    op.create_index('ix_todo_user_key_completed', 'todos', ['user_key', 'completed'], unique=False)
    op.create_index('ix_todo_user_key_key', 'todos', ['user_key', 'key'], unique=False)
    op.create_index('ix_todo_user_key_priority', 'todos', ['user_key', 'priority'], unique=False)
    op.create_index('ix_todo_user_key_status', 'todos', ['user_key', 'status'], unique=False)
